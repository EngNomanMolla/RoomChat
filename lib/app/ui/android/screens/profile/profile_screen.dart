        ...
        child: Column(
          children: [
              ...
              child: Row(
                children: [
                  ClipRRect(
                      ...
                      child: Image.asset("assets/images/jpg/girl.jpg",height: 38.0,width: 38.0,fit: BoxFit.cover)),
                   SizedBox(width: 20.0),
                  Column(
                    mainAxisAlignment: MainAxisAlignment.start,
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Text("Abdullah Al Noman",style: TextStyle(
                          fontSize: 16.0,
                      ...
                      Row(
                        children: [
                          Text("ID: ${"676767"}",style: TextStyle(
                              fontSize: 16.0,
            ...
            ListTile(
              ...
              trailing: Icon(Icons.arrow_forward_ios,size: 16.0),
              title: Text("Level",style: TextStyle(
                fontFamily: 'Montserrat',
              ),
              ),
